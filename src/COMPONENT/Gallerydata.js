...
import sofa2 from './img/Total inspirational, this home is absolutely perfect😍.jpg';
import livingRoom2 from './img/01.jpg';
import livingRoom3 from './img/Describe this living room decor inspiration in one word ❤️.jpg';
...
import lighting1 from './img/Large Wood Pendant Light, Scandinavian Chandelier Lighting, Bamboo Japandi Light Fixtures for Dining Room,veneer Lamp,suspension Light Cloud - Etsy.jpg';
import lighting2 from './img/Reality Cameron Pendelleuchte Braun, 4-flammig.jpg';
import lighting3 from './img/Nordic Crystal Lamp USB Table Lamps Bedroom Touch Dimming Atmosphere Diamond Night Light Rose Projector Lamp Decor - Yellow _ 3colors _ USB.jpg';
